...
export async function GET() {
  try {
    ...
    if (userCount > 5) return NextResponse.json({ ok: true, message: 'Already seeded', userCount })
    ...
    const users = [
      ...
      { username: 'm_power_chris', name: 'Chris Okafor',  email: 'chris@demo.carmodlist.com',  bio: 'F82 M4 guy. Track days on weekends.' },
      { username: 'boost_nina',    name: 'Nina Petrov',   email: 'nina@demo.carmodlist.com',   bio: 'First mod was an exhaust. Last was turbos.' },
      { username: 'euro_tony',     name: 'Tony Gallo',    email: 'tony@demo.carmodlist.com',   bio: 'Supra owner trying to make it BMW fast.' },
      { username: 'nj_m_cars',     name: 'Derek Walsh',   email: 'derek@demo.carmodlist.com',  bio: 'NJ based. E46 purist turned G80 convert.' },
      { username: 'subie_killer',  name: 'Marcus Lee',    email: 'marcus@demo.carmodlist.com', bio: 'Killing Subies at the light since 2019.' },
    ]

    const idMap: Record<string, string> = {}
    for (const u of users) {
      const created = await prisma.user.create({ data: { id: makeId(), ...u, password: pw } })
      idMap[u.username] = created.id
    }

    type Mod = { category: string; name: string; brand: string; price: number; isTune?: boolean; tunerName?: string; tunerUrl?: string; vendorUrl?: string }
    type Build = { username: string; title: string; year: number; make: string; model: string; trim?: string; fuel: string; hpStock: number; hpTuned: number; mods: Mod[] }

    const builds: Build[] = [
      { username: 'bmw_mike', title: 'F80 M3 Competition Build', year: 2018, make: 'BMW', model: 'M3', trim: 'Competition', fuel: 'E40', hpStock: 444, hpTuned: 620, mods: [
        ...
        { category: 'Brakes',     name: 'Brembo GT Big Brake Kit',       brand: 'Brembo',        price: 3100 },
      ]},
      { username: 'bmw_mike', title: 'X5M E40 Sleeper SUV', year: 2019, make: 'BMW', model: 'X5M', fuel: 'E40', hpStock: 600, hpTuned: 780, mods: [
        ...
        { category: 'Suspension', name: 'KW HLS 4 Lift System',           brand: 'KW Suspension', price: 3200 },
        { category: 'Wheels',     name: 'HRE S201H 22in Brushed Dark',    brand: 'HRE',           price: 6400 },
      ]},
      { username: 'amg_pete', title: 'C63 AMG S Daily Beast', year: 2020, make: 'Mercedes', model: 'C63 AMG S', fuel: 'Pump', hpStock: 503, hpTuned: 680, mods: [
        ...
        { category: 'Engine',     name: 'Eventuri Carbon Intake',         brand: 'Eventuri',      price: 950 },
        { category: 'Wheels',     name: 'Vossen HF-2 20in Wheels',       brand: 'Vossen',        price: 3600 },
      ]},
      { username: 'amg_pete', title: 'A45 AMG Pocket Rocket', year: 2019, make: 'Mercedes', model: 'A45 AMG', fuel: 'Pump', hpStock: 381, hpTuned: 480, mods: [
        ...
        { category: 'Engine',     name: 'Eventuri Black Carbon Intake',   brand: 'Eventuri',      price: 1050 },
      ...
      { username: 'porsche_alex', title: 'GT3 Track Weapon', year: 2022, make: 'Porsche', model: '911 GT3', fuel: 'Pump', hpStock: 502, hpTuned: 502, mods: [
        { category: 'Suspension', name: 'Ohlins TTX36 Track Suspension',     brand: 'Ohlins',      price: 5200 },
        { category: 'Brakes',     name: 'Pagid RSL1 Track Brake Pads',       brand: 'Pagid',       price: 420 },
      ...
      { username: 'porsche_alex', title: '718 Cayman S Track Prep', year: 2019, make: 'Porsche', model: '718 Cayman S', fuel: 'Pump', hpStock: 350, hpTuned: 420, mods: [
      ...
      { username: 'm_power_sal', title: 'E46 M3 Resto-Mod', year: 2003, make: 'BMW', model: 'M3', trim: 'E46', fuel: 'E30', hpStock: 333, hpTuned: 410, mods: [
        ...
        { category: 'Engine',     name: 'Dinan Cold Air Intake',           brand: 'Dinan',             price: 480 },
      ...
      { username: 'm_power_sal', title: 'E90 M3 Track Car', year: 2010, make: 'BMW', model: 'M3', trim: 'E90', fuel: 'Pump', hpStock: 414, hpTuned: 440, mods: [
      ...
      { username: 'turbo_jay', title: '135i N55 Sleeper', year: 2013, make: 'BMW', model: '135i', fuel: 'E30', hpStock: 300, hpTuned: 480, mods: [
        ...
        { category: 'Engine',     name: 'VRSF Intercooler Upgrade',         brand: 'VRSF',               price: 580 },
      ...
      { username: 'turbo_jay', title: 'M240i B58 Street Fighter', year: 2022, make: 'BMW', model: 'M240i', fuel: 'E30', hpStock: 382, hpTuned: 500, mods: [
      ...
      { username: 'stage2_rob', title: 'G80 M3 Street/Track', year: 2022, make: 'BMW', model: 'M3', trim: 'Competition', fuel: 'E40', hpStock: 503, hpTuned: 750, mods: [
      ...
      { username: 'stage2_rob', title: 'A90 Supra GR Build', year: 2021, make: 'Toyota', model: 'Supra GR', fuel: 'E30', hpStock: 382, hpTuned: 550, mods: [
      ...
      { username: 'trackday_lou', title: 'Cayman GT4 Track Build', year: 2021, make: 'Porsche', model: 'Cayman GT4', fuel: 'Pump', hpStock: 414, hpTuned: 440, mods: [
      ...
      { username: 'trackday_lou', title: '992 Carrera S Touring Build', year: 2020, make: 'Porsche', model: '911 Carrera S', fuel: 'Pump', hpStock: 443, hpTuned: 520, mods: [
      ...
      { username: 'e85_king', title: 'G82 M4 Competition E85', year: 2023, make: 'BMW', model: 'M4', trim: 'Competition', fuel: 'E85', hpStock: 503, hpTuned: 820, mods: [
      ...
      { username: 'e85_king', title: 'M2 Competition E40 Build', year: 2020, make: 'BMW', model: 'M2 Competition', fuel: 'E40', hpStock: 405, hpTuned: 580, mods: [
        { category: 'Engine',     name: 'MHD Stage 2 E40 Tune',       brand: 'MHD',           price: 599, isTune: true, tunerName: 'ECMTuner', tunerUrl: 'https://ecmtuner.com' },
      ...
      { username: 'm_power_chris', title: 'F82 M4 S55 Track Beast', year: 2015, make: 'BMW', model: 'M4', fuel: 'E40', hpStock: 425, hpTuned: 600, mods: [
      ...
      { username: 'm_power_chris', title: 'M235i N55 Daily', year: 2016, make: 'BMW', model: 'M235i', fuel: 'E30', hpStock: 322, hpTuned: 440, mods: [
        ...
        { category: 'Engine',     name: 'VRSF Front Mount Intercooler', brand: 'VRSF',        price: 650 },
      ...
      { username: 'boost_nina', title: 'E63 AMG S Wagon', year: 2017, make: 'Mercedes', model: 'E63 AMG S', trim: 'Wagon', fuel: 'Pump', hpStock: 603, hpTuned: 780, mods: [
      ...
      { username: 'boost_nina', title: 'A35 AMG Hot Hatch', year: 2022, make: 'Mercedes', model: 'A35 AMG', fuel: 'Pump', hpStock: 302, hpTuned: 390, mods: [
        { category: 'Engine',     name: 'RENNtech Stage 1 Flash',       brand: 'RENNtech',      price: 950, isTune: true, tunerName: 'ECMTuner', tunerUrl: 'https://ecmtuner.com' },
        { category: 'Exhaust',    name: 'Akrapovic Slip-On Titanium',   brand: 'Akrapovic',     price: 2800 },
        { category: 'Suspension', name: 'KW V1 Street Comfort',         brand: 'KW Suspension', price: 1400 },
        { category: 'Wheels',     name: 'Vossen HF-1 19in Gloss Black', brand: 'Vossen',        price: 2800 },
      ]},
      { username: 'euro_tony', title: 'A90 Supra Full Build', year: 2021, make: 'Toyota', model: 'Supra GR', fuel: 'E30', hpStock: 382, hpTuned: 520, mods: [
        { category: 'Engine',     name: 'MHD Stage 2 E30 Tune',              brand: 'MHD',           price: 499, isTune: true, tunerName: 'ECMTuner', tunerUrl: 'https://ecmtuner.com' },
        { category: 'Engine',     name: 'Mishimoto Performance Intercooler', brand: 'Mishimoto',     price: 620 },
        { category: 'Exhaust',    name: 'ARK Performance Catback',           brand: 'ARK Performance', price: 1400 },
        { category: 'Suspension', name: 'BC Racing BR Coilovers',            brand: 'BC Racing',     price: 1100 },
        { category: 'Wheels',     name: 'Gram Lights 57CR 19in',             brand: 'Gram Lights',   price: 1800 },
      ]},
      { username: 'euro_tony', title: 'GLE63 AMG S Family Hauler', year: 2021, make: 'Mercedes', model: 'GLE63 AMG S', fuel: 'Pump', hpStock: 603, hpTuned: 750, mods: [
        ...
        { category: 'Exhaust',    name: 'Capristo Exhaust System',      brand: 'Capristo',      price: 5200 },
        { category: 'Suspension', name: 'KW V3 Coilovers',              brand: 'KW Suspension', price: 2800 },        { category: 'Wheels',     name: 'Vossen HF-7 22in Gloss Black', brand: 'Vossen',        price: 4800 },
      ]},
      { username: 'nj_m_cars', title: 'M340i Weekend Toy', year: 2021, make: 'BMW', model: 'M340i', fuel: 'E30', hpStock: 382, hpTuned: 520, mods: [
        { category: 'Engine',     name: 'MHD Stage 2 E30 Tune',          brand: 'MHD',           price: 499, isTune: true, tunerName: 'ECMTuner', tunerUrl: 'https://ecmtuner.com' },
      ...
      { username: 'nj_m_cars', title: 'G80 M3 Competition xDrive', year: 2023, make: 'BMW', model: 'M3', trim: 'Competition xDrive', fuel: 'E40', hpStock: 503, hpTuned: 650, mods: [
        { category: 'Engine',     name: 'MHD Stage 2 E40 Tune',          brand: 'MHD',           price: 699, isTune: true, tunerName: 'ECMTuner', tunerUrl: 'https://ecmtuner.com' },
        { category: 'Engine',     name: 'Wagner EVO2 Intercooler',        brand: 'Wagner Tuning', price: 1100 },
        { category: 'Exhaust',    name: 'MTEK Downpipes',                 brand: 'MTEK',          price: 1400 },
        { category: 'Suspension', name: 'KW V3 Coilovers',               brand: 'KW Suspension', price: 2400 },
      ]},
      { username: 'subie_killer', title: '340i Daily Driver', year: 2019, make: 'BMW', model: '340i', fuel: 'E30', hpStock: 326, hpTuned: 450, mods: [
      ...
      { username: 'subie_killer', title: 'M5 Competition Stage 3', year: 2021, make: 'BMW', model: 'M5 Competition', fuel: 'E40', hpStock: 617, hpTuned: 800, mods: [
    ...
    for (const b of builds) {
      const userId = idMap[b.username]
      if (!userId) continue
      const totalCost = b.mods.reduce((sum, m) => sum + m.price, 0)
      const build = await prisma.build.create({
        data: { id: makeId(), userId, slug: makeSlug(b.title), title: b.title, year: b.year, make: b.make, model: b.model, trim: b.trim, fuel: b.fuel, hpStock: b.hpStock, hpTuned: b.hpTuned, isPublic: true, totalCost },
      })
      totalBuilds++
      for (const m of b.mods) {
        await prisma.mod.create({
          data: { id: makeId(), buildId: build.id, category: m.category, name: m.name, brand: m.brand, price: m.price, isTune: m.isTune ?? false, tunerName: m.tunerName, tunerUrl: m.tunerUrl, vendorUrl: m.vendorUrl },
        })
        totalMods++
      }
    }

    return NextResponse.json({ ok: true, message: 'Seeded successfully', usersCreated: Object.keys(idMap).length, buildsCreated: totalBuilds, modsCreated: totalMods })
  } catch (error: any) {
