...
export async function GET() {
  try {
    ...
    const usersData = [
      ...
      { username: "boost_nina",   name: "Nina Petrov",    email: "nina@demo.carmodlist.com",    bio: "First mod was an exhaust. Last mod was turbos. No regrets." },
    ...
    const builds: BuildDef[] = [
      ...
      { username: "nj_m_cars", title: "M340i Weekend Toy",
      ...
      { username: "boost_nina", title: "E63 AMG S Wagon",
      ...
      { username: "subie_killer", title: "340i Daily Driver",
      ...
      { username: "euro_tony", title: "Supra GR A90 Build",
      ...
      { username: "m_power_chris", title: "M235i N55 Quick Build",
      ...
      { username: "nj_m_cars", title: "M240i B58 Street Fighter",
      ...
      { username: "m_power_chris", title: "F82 M4 S55 Track Beast",
      ...
      { username: "subie_killer", title: "M5 Competition Stage 3 Monster",
      ...
      { username: "stage2_rob", title: "M5 Competition Stage 2 Daily",
        year: 2020, make: "BMW", model: "M5 Competition", fuel: "E40", hpStock: 617, hpTuned: 730,
        mods: [
          { category: "Engine",     name: "MHD Stage 2 E40 Tune",     brand: "MHD",           price: 699, isTune: true, tunerName: "ECMTuner", tunerUrl: "https://ecmtuner.com" },
          { category: "Engine",     name: "Wagner EVO2 Intercooler",   brand: "Wagner Tuning", price: 1100 },
          { category: "Exhaust",    name: "MTEK Downpipes",            brand: "MTEK",          price: 1400 },
          { category: "Wheels",     name: "Apex SM-10 20in Gunmetal",  brand: "Apex Wheels",   price: 2800 },
        ] },
      ...
      { username: "boost_nina", title: "A35 AMG Hot Hatch",
        year: 2022, make: "Mercedes", model: "A35 AMG", fuel: "Pump", hpStock: 302, hpTuned: 390,
        mods: [
      ...
      { username: "euro_tony", title: "718 Boxster GTS 4.0",
        year: 2021, make: "Porsche", model: "718 Boxster GTS", fuel: "Pump", hpStock: 394, hpTuned: 420,
        mods: [
          { category: "Exhaust",    name: "Akrapovic Slip-On Race Exhaust", brand: "Akrapovic",     price: 4200 },
          { category: "Suspension", name: "Ohlins Road and Track",          brand: "Ohlins",        price: 3800 },
          { category: "Wheels",     name: "Forgeline GA1R 20in",            brand: "Forgeline",     price: 6200 },
          { category: "Brakes",     name: "Pagid RSL1 Track Pads",          brand: "Pagid",         price: 420 },
        ] },
    ]
